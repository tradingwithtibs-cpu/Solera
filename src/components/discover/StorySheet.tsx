 ...
 * the story was fetched for at their live price. Comments arrive with
 * sign-in (task S2); the composer renders disabled until then.
 */
      ...
      <div className="sheet-box wide glass glass-era" role="dialog" aria-modal="true" aria-labelledby="story-title">
        <div className="story">
          ...
          <div className="story-comments">
            ...
            <p className="tr-empty">Comments open with sign-in.</p>
            <form
              className="cmt-form"
              onSubmit={(e) => {
                e.preventDefault();
